...
class ChatGPTQAService
{
    ...
    /**
     * Generate QA pairs from text using ChatGPT API
     */
    public function generateQAPairs(string $text): array
    {
        ...
        try {
            ...
            if ($response->successful()) {
                $qaResponse = $response->json()['choices'][0]['message']['content'] ?? '';
            ...
            Log::error('ChatGPT API exception', ['error' => $e->getMessage()]);
        }
